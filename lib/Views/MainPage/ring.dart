...
class RingProduct extends StatefulWidget {
  const RingProduct({Key? key}) : super(key: key);

  @override
  State<RingProduct> createState() => _RingProductState();
}

class _RingProductState extends State<RingProduct> {
  ...
  Future<List<Map<String, dynamic>>> _fetchProductData() async {
    try {
      return await DatabaseService().fetchRingProducts();
    } catch (error) {
